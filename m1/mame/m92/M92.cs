...
namespace mame
{
    public partial class M92
    {
        ...
        public static void M92Init()
        {
            ...
            bb1 = new byte[0x10000]; //Machine.GetRom("maincpu.rom");
            ...
            gfx1rom = new byte[0x100000];// Machine.GetRom("gfx1.rom");
            n1 = gfx1rom.Length;
            ...
            gfx2rom = new byte[0x100000];// Machine.GetRom("gfx2.rom");
            n2 = gfx2rom.Length;
            ...
            eeprom = new byte[0x10000];// Machine.GetRom("eeprom.rom");
            m92_game_kludge = 0;
