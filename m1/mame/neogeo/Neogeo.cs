...
namespace mame
{
    public partial class Neogeo
    {
        ...
        public static void NeogeoInit()
        {
            ...
            fixedrom = new byte[0x10000];// Machine.GetRom("fixed.rom");
        ...
        public static void stopandplay_neogeo_default(TrackInfo ti)
        {
            ...
            Inptport.lsFA.Add(new FrameArray(Video.screenstate.frame_number + 2, 0, 7));
        ...
        public static void play_neogeo_mslug2(TrackInfo ti)
        {
            if (ti.IndexList == 3)
            {
                Inptport.lsFA.Add(new FrameArray(Video.screenstate.frame_number, 0, 30));
            }
            else
            {
                Inptport.lsFA.Add(new FrameArray(Video.screenstate.frame_number, 0, 0));
            }
            Inptport.lsFA.Add(new FrameArray(Video.screenstate.frame_number + 1, 0, (byte)ti.TrackID));
        }
        ...
        public static void stopandplay_neogeo_mslug2(TrackInfo ti)
        {
            ...
            if (ti.IndexList == 3)
            {
                Inptport.lsFA.Add(new FrameArray(Video.screenstate.frame_number + 1, 0, 30));
            }
            else
            {
                Inptport.lsFA.Add(new FrameArray(Video.screenstate.frame_number + 1, 0, 0));
            }
        ...
        {
            Inptport.lsFA.Add(new FrameArray(Video.screenstate.frame_number, 0, 252));
            Inptport.lsFA.Add(new FrameArray(Video.screenstate.frame_number + 1, 0, (byte)ti.TrackID));
        }
        ...
        public static void stopandplay_neogeo_aodk(TrackInfo ti)
        {
            Inptport.lsFA.Add(new FrameArray(Video.screenstate.frame_number, 0, 252));
            Inptport.lsFA.Add(new FrameArray(Video.screenstate.frame_number + 1, 0, (byte)RomInfo.IStop));
            Inptport.lsFA.Add(new FrameArray(Video.screenstate.frame_number + 2, 0, 252));
            Inptport.lsFA.Add(new FrameArray(Video.screenstate.frame_number + 3, 0, (byte)ti.TrackID));
        }
        public static void play_neogeo_wjammers(TrackInfo ti)
        {
            Inptport.lsFA.Add(new FrameArray(Video.screenstate.frame_number, 0, 23));
            Inptport.lsFA.Add(new FrameArray(Video.screenstate.frame_number + 1, 0, (byte)ti.TrackID));
        }
        ...
        public static void stopandplay_neogeo_wjammers(TrackInfo ti)
        {
            Inptport.lsFA.Add(new FrameArray(Video.screenstate.frame_number, 0, (byte)RomInfo.IStop));
            Inptport.lsFA.Add(new FrameArray(Video.screenstate.frame_number + 1, 0, (byte)RomInfo.IStop));
            Inptport.lsFA.Add(new FrameArray(Video.screenstate.frame_number + 2, 0, 23));
            Inptport.lsFA.Add(new FrameArray(Video.screenstate.frame_number + 3, 0, (byte)ti.TrackID));
        }
        public static void play_neogeo_pbobbl2n(TrackInfo ti)
        {
            Inptport.lsFA.Add(new FrameArray(Video.screenstate.frame_number, 0, 7));
            Inptport.lsFA.Add(new FrameArray(Video.screenstate.frame_number + 1, 0, 25));
            Inptport.lsFA.Add(new FrameArray(Video.screenstate.frame_number + 2, 0, (byte)ti.TrackID));
        }
        ...
        {
            Inptport.lsFA.Add(new FrameArray(Video.screenstate.frame_number, 0, (byte)RomInfo.IStop));
            Inptport.lsFA.Add(new FrameArray(Video.screenstate.frame_number + 1, 0, 7));
            Inptport.lsFA.Add(new FrameArray(Video.screenstate.frame_number + 2, 0, 25));
            Inptport.lsFA.Add(new FrameArray(Video.screenstate.frame_number + 3, 0, (byte)ti.TrackID));
        }
