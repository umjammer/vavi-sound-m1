...
public class Generic {
    ...
    private static int[] coinlockedout;
    ...
    public static short[] buffered_spriteram16;
    public static byte[] spriteram;
    public static short[] spriteram16, spriteram16_2;
    public static byte[] paletteram, paletteram_2;
    public static short[] paletteram16, paletteram16_2;
    ...
    public static void generic_machine_init() {
        int counternum;
        coin_count = new int[8];
        coinlockedout = new int[8];
        lastcoin = new int[8];
...
//                break;
    ...
    public static short watchdog_reset16_r() {
        Watchdog.watchdog_reset();
        return (short) 0xffff;
    }

    public static void nmi_0_line_pulse() {
        irqn_line_set(0, LineState.INPUT_LINE_NMI.v, LineState.PULSE_LINE.v);
    }

    public static void nmi_1_line_pulse() {
        irqn_line_set(1, LineState.INPUT_LINE_NMI.v, LineState.PULSE_LINE.v);
    }
    ...
    public static void clear_all_lines() {
        ...
        Cpuint.cpunum_set_input_line(objcpunum, LineState.INPUT_LINE_NMI.v, LineState.CLEAR_LINE);
    ...
    public static void cpu_interrupt_enable(int cpunum, int enabled) {
        ...
        if (enabled == 0) {
            objcpunum = cpunum;
            Timer.setInternal(Generic::clear_all_lines, "clear_all_lines");
        }
    }
    ...
    public static void irqn_line_set(int cpunum, int line, int state) {
        if (interrupt_enable[cpunum] != 0) {
            Cpuint.cpunum_set_input_line(cpunum, line, LineState.values()[state]);
        }
    }
    ...
    public static void nmi_line_pulse(int cpunum) {
        irqn_line_set(cpunum, LineState.INPUT_LINE_NMI.v, LineState.PULSE_LINE.v);
    }
    ...
    public static void irq0_line_hold(int cpunum) {
        irqn_line_set(cpunum, 0, LineState.HOLD_LINE.v);
    }

    public static void irq4_line_hold(int cpunum) {
        irqn_line_set(cpunum, 4, LineState.HOLD_LINE.v);
    }
    ...
    public static void irq5_line_hold(int cpunum) {
        irqn_line_set(cpunum, 5, LineState.HOLD_LINE.v);
    }

    public static short paletteram16_split(int offset) {
        return (short) (paletteram[offset] | (paletteram_2[offset] << 8));
    }

    public static void buffer_spriteram_w() {
        System.arraycopy(spriteram, 0, buffered_spriteram, 0, spriteram.length);
    }

    public static void buffer_spriteram16_w() {
        System.arraycopy(spriteram16, 0, buffered_spriteram16, 0, spriteram16.length);
    }

    public static short paletteram16_le(int offset) {
        return (short) (paletteram[offset & ~1] | (paletteram[offset | 1] << 8));
    }

    public static short paletteram16_be(int offset) {
        return (short) (paletteram[offset | 1] | (paletteram[offset & ~1] << 8));
    }

    public static void set_color_444(int color, int rshift, int gshift, int bshift, short data) {
        Palette.palette_set_callback.accept(color, Palette.make_rgb(Palette.pal4bit((byte) (data >> rshift)), Palette.pal4bit((byte) (data >> gshift)), Palette.pal4bit((byte) (data >> bshift))));
    }

    public static void set_color_555(int color, int rshift, int gshift, int bshift, short data) {
        Palette.palette_set_callback.accept(color, Palette.make_rgb(Palette.pal5bit((byte) (data >> rshift)), Palette.pal5bit((byte) (data >> gshift)), Palette.pal5bit((byte) (data >> bshift))));
    }
    ...
    public static void paletteram16_xxxxRRRRGGGGBBBB_word_w(int offset, short data) {
    ...
    public static void paletteram16_xxxxRRRRGGGGBBBB_word_w1(int offset, byte data) {
        paletteram16[offset] = (short) ((data << 8) | (paletteram16[offset] & 0xff));
        set_color_444(offset, 8, 4, 0, paletteram16[offset]);
    }

    public static void paletteram16_xxxxRRRRGGGGBBBB_word_w2(int offset, byte data) {
        paletteram16[offset] = (short) ((paletteram16[offset] & 0xff00) | data);
        set_color_444(offset, 8, 4, 0, paletteram16[offset]);
    }
    ...
    public static void paletteram16_xBBBBBGGGGGRRRRR_word_w(int offset, short data) {
        paletteram16[offset] = data;
    ...
    public static void paletteram16_RRRRGGGGBBBBRGBx_word_w(int offset, short data) {
        paletteram16[offset] = data;
        short data1 = paletteram16[offset];
        Palette.palette_set_callback.accept(offset, (Palette.pal5bit((byte) (((data1 >> 11) & 0x1e) | ((data1 >> 3) & 0x01))) << 16) | (Palette.pal5bit((byte) (((data >> 7) & 0x1e) | ((data >> 2) & 0x01))) << 8) | Palette.pal5bit((byte) (((data >> 3) & 0x1e) | ((data >> 1) & 0x01))));
    }
