...
public class Cpuexec {
    ...
    public static abstract class cpuexec_data {
        ...
        public int trigger;
        public long totalcycles;  // total CPU cycles executed
        ...
        public int icount;
        public EmuTimer partial_frame_timer;
        public Atime partial_frame_period;

        public abstract long getTotalExecutedCycles();

        public abstract void setTotalExecutedCycles(long value);

        public abstract int getPendingCycles();

        public abstract void setPendingCycles(int value);

        public abstract int ExecuteCycles(int cycles);

        public abstract void Reset();

        public abstract void set_irq_line(int irqline, LineState state);

        public abstract void cpunum_set_input_line_and_vector(int cpunum, int line, LineState state, int vector);
    }

    public static final byte SUSPEND_REASON_HALT = 0x01;
    public static final byte SUSPEND_REASON_RESET = 0x02;
    public static final byte SUSPEND_REASON_SPIN = 0x04;
    public static final byte SUSPEND_REASON_TRIGGER = 0x08;
    public static final byte SUSPEND_REASON_DISABLE = 0x10;
    public static final byte SUSPEND_ANY_REASON = (byte) 0xff;
    public static int iType, bLog, bLog0, bLog1, bLog2, bLog3;
    public static boolean bLog02, bLog12, bLog22, bLog32;
    public static boolean b11 = true, b12 = true, b13 = true, b14 = true;
    public static int iloops, activecpu, icpu, ncpu, startcpu, endcpu, iloops2;
    public static cpuexec_data[] cpu;
    public static EmuTimer timedint_timer;
    public static Atime timedint_period, timeslice_period;

    public interface vblank_delegate extends Runnable {

    }

    public static vblank_delegate vblank_interrupt;
    public static Runnable vblank_interrupt2;
    public static EmuTimer interleave_boost_timer;
    public static EmuTimer interleave_boost_timer_end;
    public static EmuTimer timeslice_timer;
    ...
    public static void cpuexec_init() {
        ...
        for (icpu = 0; icpu < ncpu; icpu++) {
            ...
            cpu[icpu].setTotalExecutedCycles(0);
            cpu[icpu].setPendingCycles(0);
        }
    ...
    public static void cpuexec_reset() {
        switch (Machine.sBoard) {
            case "CPS-1":
                ...
                switch (Machine.sName) {
                    ...
                    case "sf2m8":
                        ...
                        break;
                    case "sf2m10":
                        CPS.mainram2 = new byte[0x10_0000];
            ...
            case "Neo Geo":
                ...
                MC68000.m1.ReadByte = Neogeo::readByteM;
                MC68000.m1.ReadOpWord = Neogeo::MReadOpWord;
                MC68000.m1.ReadWord = MC68000.m1.ReadPcrelWord = Neogeo::readWordM;
                MC68000.m1.ReadOpLong = Neogeo::MReadOpLong;
                MC68000.m1.ReadLong = MC68000.m1.ReadPcrelLong = Neogeo::readLongM;
                MC68000.m1.WriteByte = Neogeo::MWriteByte;
                MC68000.m1.WriteWord = Neogeo::writeWordM;
                MC68000.m1.WriteLong = Neogeo::writeLongM;
                Z80A.zz1[0].ReadOp = Neogeo::ZReadOp;
                Z80A.zz1[0].ReadOpArg = Neogeo::ZReadOp;
                Z80A.zz1[0].ReadMemory = Neogeo::ZReadMemory;
                Z80A.zz1[0].WriteMemory = Neogeo::writeMemoryZ;
                Z80A.zz1[0].ReadHardware = Neogeo::readHardwareZ;
                Z80A.zz1[0].WriteHardware = Neogeo::writeHardwareZ;
                Z80A.zz1[0].IRQCallback = Neogeo::callbackIRQZ;
                switch (Machine.sName) {
                    case "fatfury2":
                    case "ssideki":
            ...
            case "Namco System 1":
                ...
                Namcos1.namcos1_cpu_control_w((byte) 1);
                break;
            case "IGS011":
                switch (Machine.sName) {
                    case "drgnwrld":
...
//                        break;
            ...
            case "M92":
                ...
                Nec.nn1[1].ReadIOByte = Cpuexec::null_callback1;
                Nec.nn1[1].ReadIOWord = Cpuexec::null_callback2;
                Nec.nn1[1].WriteIOByte = Cpuexec::null_callback;
                Nec.nn1[1].WriteIOWord = Cpuexec::null_callback;
                Nec.nn1[0].v25v35_decryptiontable = null;
                switch (Machine.sName) {
                    case "gunforce":
                    case "gunforcej":
        ...
        switch (Machine.sBoard) {
            ...
            case "PGM":
            case "Taito B":
                MC68000.m1.debugger_start_cpu_hook_callback = Cpuexec::null_callback;
                MC68000.m1.debugger_stop_cpu_hook_callback = Cpuexec::null_callback;
                Z80A.zz1[0].debugger_start_cpu_hook_callback = Cpuexec::null_callback;
                Z80A.zz1[0].debugger_stop_cpu_hook_callback = Cpuexec::null_callback;
                break;
            case "Tehkan":
                Z80A.zz1[1].debugger_start_cpu_hook_callback = Cpuexec::null_callback;
                Z80A.zz1[1].debugger_stop_cpu_hook_callback = Cpuexec::null_callback;
                break;
            case "IGS011":
                MC68000.m1.debugger_start_cpu_hook_callback = Cpuexec::null_callback;
                MC68000.m1.debugger_stop_cpu_hook_callback = Cpuexec::null_callback;
            ...
            case "Namco System 1":
                ...
                M6809.mm1[0].debugger_start_cpu_hook_callback = Cpuexec::null_callback;
                M6809.mm1[0].debugger_stop_cpu_hook_callback = Cpuexec::null_callback;
                M6809.mm1[1].debugger_start_cpu_hook_callback = Cpuexec::null_callback;
                M6809.mm1[1].debugger_stop_cpu_hook_callback = Cpuexec::null_callback;
                M6809.mm1[2].debugger_start_cpu_hook_callback = Cpuexec::null_callback;
                M6809.mm1[2].debugger_stop_cpu_hook_callback = Cpuexec::null_callback;
                break;
            case "M72":
                Z80A.zz1[0].debugger_start_cpu_hook_callback = Cpuexec::null_callback;
                Z80A.zz1[0].debugger_stop_cpu_hook_callback = Cpuexec::null_callback;
            ...
            case "M92":
                break;
            case "Taito":
                Z80A.zz1[2].debugger_start_cpu_hook_callback = Cpuexec::null_callback;
                Z80A.zz1[2].debugger_stop_cpu_hook_callback = Cpuexec::null_callback;
                break;
            case "Konami 68000":
                switch (Machine.sName) {
                    case "cuebrick":
    ...
    public static void trigger2() {
        ...
        if (iloops2 > 1) {
            Timer.adjustPeriodic(Cpuexec.cpu[1].partial_frame_timer, Cpuexec.cpu[1].partial_frame_period, Attotime.ATTOTIME_NEVER);
        }
    }
    ...
    public static short null_callback2(int address) {
        return 0;
    }
    ...
    public static void null_callback(int address, short value) {
    ...
    private static void cpu_inittimers() {
        switch (Machine.sBoard) {
            ...
            case "CPS2":
                ...
                timedint_timer = Timer.allocCommon(Generic::irq_1_0_line_hold, "irq_1_0_line_hold", false);
                Timer.adjustPeriodic(timedint_timer, timedint_period, timedint_period);
                break;
            case "Neo Geo":
                interleave_boost_timer = Timer.allocCommon(Cpuexec::null_callback, "boost_callback", false);
                interleave_boost_timer_end = Timer.allocCommon(Cpuexec::end_interleave_boost, "end_interleave_boost", false);
                break;
            case "CPS1":
            case "Namco System 1":
            case "IGS011":
            ...
            case "Taito":
                switch (Machine.sName) {
                    ...
                    case "bublcave10":
                        ...
                        timeslice_timer = Timer.allocCommon(Cpuexec::cpu_timeslicecallback, "cpu_timeslicecallback", false);
                        Timer.adjustPeriodic(timeslice_timer, timeslice_period, timeslice_period);
                        break;
                    case "opwolf":
                    case "opwolfa":
                    case "opwolfj":
            ...
            case "Capcom":
                switch (Machine.sName) {
                    ...
                    case "sfp":
                        ...
                        timedint_timer = Timer.allocCommon(Generic::irq_2_0_line_hold, "irq_2_0_line_hold", false);
                        Timer.adjustPeriodic(timedint_timer, timedint_period, timedint_period);
                        break;
                }
                break;
    ...
    public static void cpuexec_timeslice() {
        ...
        Atime target = Timer.lt.get(0).expire;
        ...
        for (icpu = startcpu; icpu <= endcpu; icpu++) {
            if (cpu[icpu].suspend != 0 && cpu[icpu].eatcycles != 0 && Attotime.attotime_compare(cpu[icpu].localtime, target) < 0) {
                at = Attotime.attotime_sub(target, cpu[icpu].localtime);
                cpu[icpu].cycles_running = (int) (at.seconds * cpu[icpu].cycles_per_second + at.attoseconds / cpu[icpu].attoseconds_per_cycle);
                cpu[icpu].totalcycles += cpu[icpu].cycles_running;
    ...
    public static void cpu_boost_interleave(Atime timeslice_time, Atime boost_duration) {
        ...
        Timer.adjustPeriodic(interleave_boost_timer, timeslice_time, timeslice_time);
        if (!Timer.enabled(interleave_boost_timer_end) || Attotime.attotime_compare(Timer.timeLeft(interleave_boost_timer_end), boost_duration) < 0)
            Timer.adjustPeriodic(interleave_boost_timer_end, boost_duration, Attotime.ATTOTIME_NEVER);
    }

    public static void activecpu_abort_timeslice(int cpunum) {
        int current_icount;
        current_icount = cpu[cpunum].getPendingCycles() + 1;
        cpu[cpunum].cycles_stolen += current_icount;
        cpu[cpunum].cycles_running -= current_icount;
        cpu[cpunum].setPendingCycles(-1);
    }
    ...
    public static boolean cpunum_is_suspended(int cpunum, byte reason) {
    ...
    public static Atime cpunum_get_localtime(int cpunum) {
        ...
        int cycles;
        cycles = cpu[cpunum].cycles_running - cpu[cpunum].getPendingCycles();
    ...
    public static void cpunum_suspend_until_trigger(int cpunum, int trigger, int eatcycles) {
        cpunum_suspend(cpunum, SUSPEND_REASON_TRIGGER, (byte) eatcycles);
    ...
    public static void on_vblank() {
        switch (Machine.sBoard) {
            ...
            case "CPS2":
                iloops = 0;
                CPS.cps2_interrupt();
                Timer.adjustPeriodic(Cpuexec.cpu[0].partial_frame_timer, Cpuexec.cpu[0].partial_frame_period, Attotime.ATTOTIME_NEVER);
                break;
            case "Data East":
            ...
            case "Taito":
                switch (Machine.sName) {
                    ...
                    case "bub68705":
                        ...
                        iloops = 0;
                        vblank_interrupt.run();
                        Timer.adjustPeriodic(Cpuexec.cpu[3].partial_frame_timer, Cpuexec.cpu[3].partial_frame_period, Attotime.ATTOTIME_NEVER);
                        break;
                    case "opwolf":
                    case "opwolfa":
                    case "opwolfj":
    ...
    public static void end_interleave_boost() {
        Timer.adjustPeriodic(interleave_boost_timer, Attotime.ATTOTIME_NEVER, Attotime.ATTOTIME_NEVER);
    }
