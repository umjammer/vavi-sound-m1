...
public class Video {
    ...
    public static class screen_state {
        ...
        /** current width (HTOTAL) */
        public int width;
        /** current height (VTOTAL) */
        public int height;
        /** current visible area (HBLANK end/start, VBLANK end/start) */
        public RECT visarea = new RECT();
        /** scanline of last partial update */
        public int last_partial_scan;
        /** attoseconds per frame */
        public long frame_period;
        /** attoseconds per VBLANK period */
        public long vblank_period;
        /** attoseconds per scanline */
        public long scantime;
        /** attoseconds per pixel */
        public long pixeltime;
        public Atime vblank_start_time = ATTOTIME_ZERO;
        public Atime vblank_end_time;
        public long frame_number;
    }

    public static boolean flip_screen_x, flip_screen_y;
    public static long frame_number_obj;
    public static Atime frame_update_time;
    public static screen_state screenstate = new screen_state();
    public static int video_attributes;
    private static final int PAUSED_REFRESH_RATE = 30;
    private static final int VIDEO_UPDATE_AFTER_VBLANK = 4;
    public static EmuTimer vblank_begin_timer, vblank_end_timer;
    public static EmuTimer scanline0_timer, scanline_timer;
    private static Atime throttle_emutime = ATTOTIME_ZERO, throttle_realtime, speed_last_emutime, overall_emutime;
    ...
    private static int throttle_history, overall_valid_counter, overall_real_seconds;
    private static int[] popcount;
    public static short[][] bitmapbase;
    public static int[][] bitmapbaseN;
    public static int[] bitmapcolor;
    public static int fullwidth, fullheight;
    public static boolean global_throttle;
    public static int scanline_param;
    private static BufferedImage bitmapGDI;
    private static BufferedImage[] bbmp;
    ...
    private static Raster bitmapData;
    public static int offsetx, offsety, width, height;

    public interface video_delegate extends Runnable {
    ...
    public static void video_init() {
        ...
        switch (Machine.sBoard) {
            ...
            case "CPS-1(QSound)":
                ...
                video_attributes = 0;
                bitmapGDI = new BufferedImage(Video.fullwidth, Video.fullheight, BufferedImage.TYPE_INT_ARGB);
                UI.ui_update_callback = UI::ui_updateC;
                bitmapbase = new short[2][];
                bitmapbase[0] = new short[0x200 * 0x200];
                bitmapbase[1] = new short[0x200 * 0x200];
                bbmp = new BufferedImage[3];
                bbmp[0] = new BufferedImage(512, 512, BufferedImage.TYPE_INT_ARGB);
                bbmp[1] = new BufferedImage(512, 256, BufferedImage.TYPE_INT_ARGB);
                bbmp[2] = new BufferedImage(384, 224, BufferedImage.TYPE_INT_ARGB);
            ...
            case "Data East":
                ...
                UI.ui_update_callback = UI::ui_updateC;
                bitmapbase = new short[2][];
                bitmapbase[0] = new short[0x100 * 0x100];
                bitmapbase[1] = new short[0x100 * 0x100];
                bbmp = new BufferedImage[1];
                bbmp[0] = new BufferedImage(256, 256, BufferedImage.TYPE_INT_ARGB);
            ...
            case "Neo Geo":
                ...
                bbmp = new BufferedImage[1];
                bbmp[0] = new BufferedImage(320, 224, BufferedImage.TYPE_INT_ARGB);
            ...
            case "SunA8":
                ...
                bitmapbase[1] = new short[0x100 * 0x100];
                bbmp = new BufferedImage[1];
                bbmp[0] = new BufferedImage(256, 224, BufferedImage.TYPE_INT_ARGB);
            ...
            case "Namco System 1":
                ...
                bitmapbase[0] = new short[0x200 * 0x200];
                bitmapbase[1] = new short[0x200 * 0x200];
                bbmp = new BufferedImage[2];
                bbmp[0] = new BufferedImage(512, 512, BufferedImage.TYPE_INT_ARGB);
                bbmp[1] = new BufferedImage(288, 224, BufferedImage.TYPE_INT_ARGB);
            ...
            case "IGS011":
                ...
                bitmapbase[1] = new short[0x200 * 0x200];
                bbmp = new BufferedImage[1];
                bbmp[0] = new BufferedImage(512, 240, BufferedImage.TYPE_INT_ARGB);
            ...
            case "PGM":
                ...
                bitmapbase[1] = new short[0x200 * 0x200];
                bbmp = new BufferedImage[1];
                bbmp[0] = new BufferedImage(448, 224, BufferedImage.TYPE_INT_ARGB);
            ...
            case "M72":
                ...
                UI.ui_update_callback = UI::ui_updatePGM;
                bitmapbase = new short[2][];
                bitmapbase[0] = new short[0x200 * 0x200]; // 0x11c
                bitmapbase[1] = new short[0x200 * 0x200]; // 0x11c
                bbmp = new BufferedImage[1];
                bbmp[0] = new BufferedImage(512, 284, BufferedImage.TYPE_INT_ARGB);
            ...
            case "M92":
                ...
                bitmapbase[1] = new short[0x200 * 0x200];
                bbmp = new BufferedImage[1];
                bbmp[0] = new BufferedImage(0x200, 0x100, BufferedImage.TYPE_INT_ARGB);
            ...
            case "Taito":
                ...
                switch (Machine.sName) {
                    ...
                    case "bublcave10":
                        ...
                        fullwidth = 0x100;
                        fullheight = 0x100;
                        frame_update_time = new Atime(0, 0x003c372a18883411L);
                    ...
                    case "opwolfp":
                        ...
                        screenstate.vblank_period = 0;// (long)(1e18 * 0.00256);
                        bitmapbase = new short[2][];
                        bitmapbase[0] = new short[0x140 * 0x100];
                        bitmapbase[1] = new short[0x140 * 0x100];
                        bbmp = new BufferedImage[1];
                        bbmp[0] = new BufferedImage(320, 240, BufferedImage.TYPE_INT_ARGB);
            ...
            case "Taito B":
                ...
                UI.ui_update_callback = UI::ui_updatePGM;
                bitmapbase = new short[2][];
                bitmapbase[0] = new short[0x200 * 0x100];
                bitmapbase[1] = new short[0x200 * 0x100];
                bbmp = new BufferedImage[1];
                bbmp[0] = new BufferedImage(320, 224, BufferedImage.TYPE_INT_ARGB);
            ...
            case "Konami 68000":
                ...
                bitmapbase[1] = new short[0x200 * 0x100];
                bbmp = new BufferedImage[1];
                bbmp[0] = new BufferedImage(288, 224, BufferedImage.TYPE_INT_ARGB);
            ...
            case "Capcom":
                switch (Machine.sName) {
                    ...
                    case "sfp":
                        ...
                        bitmapbase[1] = new short[0x200 * 0x100];
                        bbmp = new BufferedImage[1];
                        bbmp[0] = new BufferedImage(384, 224, BufferedImage.TYPE_INT_ARGB);
        ...
        screenstate.pixeltime = screenstate.frame_period / ((long) screenstate.height * screenstate.width);
        screenstate.frame_number = 0;
        bitmapGDI = new BufferedImage(Video.fullwidth, Video.fullheight, BufferedImage.TYPE_INT_ARGB);
        bitmapcolor = new int[Video.fullwidth * Video.fullheight];
        vblank_begin_timer = Timer.allocCommon(Video::vblank_begin_callback, "vblank_begin_callback", false);
        Timer.adjustPeriodic(vblank_begin_timer, video_screen_get_time_until_vblank_start(), Attotime.ATTOTIME_NEVER);
        scanline0_timer = Timer.allocCommon(Video::scanline0_callback, "scanline0_callback", false);
        Timer.adjustPeriodic(scanline0_timer, video_screen_get_time_until_pos(0, 0), Attotime.ATTOTIME_NEVER);
        vblank_end_timer = Timer.allocCommon(Video::vblank_end_callback, "vblank_end_callback", false);
        switch (Machine.sBoard) {
            case "CPS-1":
            case "CPS-1(QSound)":
            case "Namco System 1":
            ...
            case "CPS2":
                ...
                Cpuexec.cpu[0].partial_frame_timer = Timer.allocCommon(Cpuexec::trigger_partial_frame_interrupt, "trigger_partial_frame_interrupt", false);
                break;
            case "Tehkan":
                Cpuexec.cpu[1].partial_frame_period = Attotime.attotime_div(Video.frame_update_time, 2);
                Cpuexec.cpu[1].partial_frame_timer = Timer.allocCommon(Cpuexec::trigger_partial_frame_interrupt, "trigger_partial_frame_interrupt", false);
                break;
            case "Neo Geo":
                break;
            case "SunA8":
                ...
                Cpuexec.cpu[1].partial_frame_timer = Timer.allocCommon(Cpuexec::trigger2, "trigger2", false);
                break;
            case "IGS011":
                switch (Machine.sName) {
                    case "drgnwrld":
            ...
            case "Taito":
                switch (Machine.sName) {
                    case "bub68705":
                        ...
                        Cpuexec.cpu[3].partial_frame_timer = Timer.allocCommon(Cpuexec::trigger_partial_frame_interrupt, "trigger_partial_frame_interrupt", false);
                        break;
                }
                break;
            case "Konami 68000":
        ...
        screenstate.vblank_start_time = ATTOTIME_ZERO;
    ...
    public static void video_screen_configure(int width, int height, RECT visarea, long frame_period) {
        ...
        screenstate.pixeltime = frame_period / ((long) height * width);
...
//        update_refresh_speed(screen.machine);
    ...
    public static boolean video_screen_update_partial(int scanline) {
    ...
    public static int video_screen_get_vpos() {
        long delta = Attotime.attotime_to_attoseconds(Attotime.attotime_sub(Timer.getCurrentTime(), screenstate.vblank_start_time));
        int vpos;
    ...
    public static boolean video_screen_get_vblank() {
        return (Attotime.attotime_compare(Timer.getCurrentTime(), screenstate.vblank_end_time) < 0);
    }

    public static Atime video_screen_get_time_until_pos(int vpos, int hpos) {
        long curdelta = Attotime.attotime_to_attoseconds(Attotime.attotime_sub(Timer.getCurrentTime(), screenstate.vblank_start_time));
        long targetdelta;
    ...
    public static Atime video_screen_get_time_until_vblank_end() {
        Atime ret;
        Atime current_time = Timer.getCurrentTime();
    ...
    private static boolean effective_throttle() {
...
//            return false;
    ...
    public static void vblank_begin_callback() {
        ...
        if (screenstate.vblank_period == 0) {
            ...
            Timer.adjustPeriodic(vblank_end_timer, video_screen_get_time_until_vblank_end(), Attotime.ATTOTIME_NEVER);
        }
    }
    ...
    public static void scanline_update_callback() {
        ...
        Timer.adjustPeriodic(scanline_timer, video_screen_get_time_until_pos(scanline, 0), Attotime.ATTOTIME_NEVER);
    }
...
resync:
        {
            ...
            throttle_history = (throttle_history << 1) | (emu_delta_attoseconds > real_delta_attoseconds ? 1 : 0);
    ...
    public static void flip_screen_set_no_update(boolean on) {
        flip_screen_x = on;
    }

    public static boolean flip_screen_get() {
...
//#region Gdi
    ...
    public interface drawcrosshairdelegate extends Function<BufferedImage, BufferedImage> {}

    public static drawcrosshairdelegate drawcrosshair;

    public static BufferedImage drawcrosshair_null(BufferedImage bm1) {
        BufferedImage bm2 = bm1;
        return bm2;
    }

    public static BufferedImage drawcrosshair_opwolf(BufferedImage bm1) {
        BufferedImage bm2 = bm1;
        Graphics g = bm2.createGraphics();
        g.drawImage(MultiplyAlpha(Crosshair.global.bitmap[0], (float) Crosshair.global.fade / 0xff), Crosshair.global.x[0] - 10, Crosshair.global.y[0] - 10, 20, 20, 0, 0, 100, 100, null);
        g.dispose();
        return bm2;
    }

    /**
     * @see "https://chatgpt.com/c/675b52fd-3b7c-8005-acfa-d9619995d8af"
     */
    public static BufferedImage MultiplyAlpha(BufferedImage bitmap, float factor) {
        if (bitmap.getType() != BufferedImage.TYPE_INT_ARGB) {
            throw new IllegalArgumentException("Image must be of type ARGB.");
        }

        // Get the raster (pixel data) of the image
        WritableRaster raster = bitmap.getRaster();

        // Loop through each pixel to modify the alpha channel
        int width = bitmap.getWidth();
        int height = bitmap.getHeight();

        for (int y = 0; y < height; y++) {
            for (int x = 0; x < width; x++) {
                int[] pixel = raster.getPixel(x, y, (int[]) null); // Get RGBA values
                int alpha = pixel[3]; // Get alpha channel value (0-255)

                // Multiply alpha by the factor and clamp it to [0, 255]
                alpha = Math.min(255, Math.max(0, Math.round(alpha * factor)));

                pixel[3] = alpha; // Set new alpha value
                raster.setPixel(x, y, pixel); // Write pixel back
            }
        }
    ...
    public static void GDIDraw() {
        try {
            bitmapData = bitmapGDI.getData(new Rectangle(0, 0, Video.fullwidth, Video.fullheight));
            System.arraycopy(Video.bitmapcolor, 0, ((DataBufferInt) bitmapData.getDataBuffer()).getData(), 0, Video.fullwidth * Video.fullheight);
            bitmapGDI.setData(bitmapData);
            if (Wintime.osd_ticks() < popup_text_end) {
                //Machine.FORM.tsslStatus.setText(sDrawText);
            } else {
                popup_text_end = 0;
                if (Mame.paused) {
                    //Machine.FORM.tsslStatus.setText("pause");
                } else {
                    switch (Mame.playState) {
                        case PLAY_RECORDRUNNING:
                            //Machine.FORM.tsslStatus.setText("record");
                            break;
                        case PLAY_REPLAYRUNNING:
                            //Machine.FORM.tsslStatus.setText("replay");
                            break;
                        default:
                            //Machine.FORM.tsslStatus.setText("run");
                            break;
                    }
                }
            }
            bbmp[iMode] = bitmapGDI.getSubimage(offsetx, offsety, width, height);
            switch (Machine.sDirection) {
                case "":
                    break;
                case "90":
                    bbmp[iMode] = rotate90Clockwise(bbmp[iMode]);
                    break;
                case "180":
                    bbmp[iMode] = rotate90Clockwise(bbmp[iMode]);
                    bbmp[iMode] = rotate90Clockwise(bbmp[iMode]);
    ...
    /**
     * @see "https://chatgpt.com/c/675b5217-aa10-8005-a99d-84420edc158e"
     */
