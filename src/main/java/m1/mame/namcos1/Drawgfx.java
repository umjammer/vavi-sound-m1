...
public class Drawgfx {
    ...
    private static void setpixelcolorNa(int offsety, int offsetx, int n) {
        if (Tilemap.priority_bitmap[offsety][offsetx] != 0x1f &&
                Tilemap.priority_bitmap[offsety][offsetx] <= Namcos1.namcos1_pri) {
            Video.bitmapbase[Video.curbitmap][offsety * 0x200 + offsetx] = (short) n;
        }
