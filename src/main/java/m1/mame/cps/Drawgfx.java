...
public class Drawgfx {
    ...
    public static void common_drawgfx_c(byte[] bb1, int code, int color, int flipx, int flipy, int sx, int sy, int primask, RECT clip) {
        int ox;
        int oy;
        int ex;
        int ey;
    ...
    private static void blockmove_4toN_transpen_pri16(byte[] bb1, int code, int srcwidth, int srcheight, int srcmodulo, int leftskip, int topskip, int flipx, int flipy, int dstwidth, int dstheight, int colorbase, int offsety, int offsetx, int primask) {
