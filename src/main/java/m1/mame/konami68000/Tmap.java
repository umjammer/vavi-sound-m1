...
public class Tmap extends Tilemap.Tmap {
    ...
    public void tile_updateKonami68000_0(int col, int row) {
        ...
        Konami68000.K052109_callback.accept(0, bank, code, color, flags, priority, /* out */ code2, /* out */ color2, /* out */ flags2);
        code = code2[0];
        color = color2[0];
        flags = flags2[0];
    ...
    public void tile_updateKonami68000_1(int col, int row) {
        ...
        flipy = color & 0x02;
        int[] code2 = new int[1], color2 = new int[1], flags2 = new int[1];
        Konami68000.K052109_callback.accept(1, bank, code, color, flags, priority, /* out */ code2, /* out */ color2, /* out */ flags2);
        code = code2[0];
        color = color2[0];
        flags = flags2[0];
        if ((Konami68000.K052109_tileflip_enable & 1) == 0) {
    ...
    public void tile_updateKonami68000_2(int col, int row) {
        ...
        flipy = color & 0x02;
        int[] code2 = new int[1], color2 = new int[1], flags2 = new int[1];
        Konami68000.K052109_callback.accept(2, bank, code, color, flags, priority, /* out */ code2, /* out */ color2, /* out */ flags2);
        code = code2[0];
        color = color2[0];
        flags = flags2[0];
        if ((Konami68000.K052109_tileflip_enable & 1) == 0) {
