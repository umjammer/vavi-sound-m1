...
public class Taitosnd {
    ...
    public static void taitosound_port16_msb_w(short data) {
    ...
    public static void taitosound_comm16_msb_w(short data) {
        //if (ACCESSING_BITS_8_15)
    ...
    public static short taitosound_comm16_msb_r() {
        return (short) (taitosound_comm_r(0) << 8);
    }
