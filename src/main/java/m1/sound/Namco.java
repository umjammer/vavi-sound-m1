...
public class Namco {
    ...
    public static class namco_sound {
    ...
    public static int namco_update_one(int[] buffer, int length, short[] wave, int counter, int freq) {
        int i;
        for (i = 0; i < length; i++) {
                    ...
                    for (i = 0; i < length; i++) {
                        ...
                        for (; cnt > 0; cnt--) {
                            ...
                            if ((nam1.channel_list[voice].noise_seed & 1) != 0)
                                nam1.channel_list[voice].noise_seed ^= 0x2_8000;
