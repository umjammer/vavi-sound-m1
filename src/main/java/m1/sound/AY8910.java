...
public class AY8910 {
    ...
    public static class _ay_ym_param {
    ...
    public static class ay8910_context {
    ...
    public static class ay8910_interface {

        public int flags;
        public int[] res_load;
        // read8handler
        public Function<Integer, Byte> portAread;
        // read8handler
        public Function<Integer, Byte> portBread;
        // write8handler
        public BiConsumer<Integer, Byte> portAwrite;
        // write8handler
        public BiConsumer<Integer, Byte> portBwrite;
    }

    public static _ay_ym_param ay_ym_param, ay_ym_param_env;
    public ay8910_context ay8910info;
    public static final AY8910[] AA8910 = new AY8910[3];
    ...
    public static void ay8910_start_ym(int chip_type, int sndindex, int clock, ay8910_interface intf) {
        ...
        AA8910[sndindex].stream = new Streams(clock / 8, 0, AA8910[sndindex].ay8910info.streams, AA8910[sndindex]::ay8910_update);
    ...
    private void ay8910_write_reg(int r, byte v) {
        ...
        switch (r) {
            ...
            case 7:
                if ((ay8910info.last_enable == -1) || ((ay8910info.last_enable & 0x40) != (ay8910info.regs[7] & 0x40))) {
                    if (ay8910_intf.portAwrite != null) {
                        ay8910_intf.portAwrite.accept(0, (ay8910info.regs[7] & 0x40) != 0 ? ay8910info.regs[14] : (byte) 0xff);
                    }
                }
                if ((ay8910info.last_enable == -1) || ((ay8910info.last_enable & 0x80) != (ay8910info.regs[7] & 0x80))) {
                    if (ay8910_intf.portBwrite != null) {
                        ay8910_intf.portBwrite.accept(0, (ay8910info.regs[7] & 0x80) != 0 ? ay8910info.regs[15] : (byte) 0xff);
                    }
                }
            ...
            case 13:
                ...
                ay8910info.env_step = ay8910info.env_step_mask;
            ...
            case 14:
                if ((ay8910info.regs[7] & 0x40) != 0) {
                    if (ay8910_intf.portAwrite != null) {
                        ay8910_intf.portAwrite.accept(0, ay8910info.regs[14]);
                    }
                }
                break;
            case 15:
                if ((ay8910info.regs[7] & 0x80) != 0) {
                    if (ay8910_intf.portBwrite != null) {
                        ay8910_intf.portBwrite.accept(0, ay8910info.regs[15]);
                    }
                }
                break;
        }
        ...
        switch (r) {
            case 14:
                if (ay8910_intf.portAread != null) {
                    ay8910info.regs[14] = ay8910_intf.portAread.apply(0);
                }
                break;
            case 15:
                if (ay8910_intf.portBread != null) {
                    ay8910info.regs[15] = ay8910_intf.portBread.apply(0);
                }
                break;
        }
